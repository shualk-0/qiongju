...
function initializeGallery() {
    ...
    const allImages = [
        ...
        // 琼韵回响 - 琼艺洲图片
        { src: '琼艺州2.jpg', title: '传统琼剧表演舞台', description: '展现琼剧艺术的独特魅力', path: '琼艺州2.jpg' },
        ...
        // 其他图片
        { src: '11 (1).jpg', title: '琼剧艺术展示', description: '琼剧艺术精彩瞬间', path: '11 (1).jpg' },
        { src: '11 (2).jpg', title: '琼剧表演艺术', description: '琼剧表演的艺术魅力', path: '11 (2).jpg' },
        { src: '11 (3).jpg', title: '琼剧文化展示', description: '琼剧文化的独特魅力', path: '11 (3).jpg' }
    ];
...
function showProductDetails(productId) {
    const productDetails = {
        ...
        'product3': {
            name: '琼剧杯垫',
            description: '琼剧元素杯垫套装，实用美观，家居装饰。一套4个，不同图案设计，采用环保材料制作，安全无毒。',
            price: 15,
            image: '杯垫.jpg',
            originalPrice: null
        },
